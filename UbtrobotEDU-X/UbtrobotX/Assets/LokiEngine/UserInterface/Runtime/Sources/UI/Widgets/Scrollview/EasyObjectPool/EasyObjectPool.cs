...
namespace SG
{
    ...
    public enum EPoolInflationType
    {
    ...
    class Pool
    {
        ...
        private EPoolInflationType inflationType;
        ...
        public GameObject NextAvailableObject(bool autoActive)
        {
            ...
            else
            {
                ...
                if (inflationType == EPoolInflationType.INCREMENT)
                {
                    increaseSize = 1;
                }
                else if (inflationType == EPoolInflationType.DOUBLE)
                {
